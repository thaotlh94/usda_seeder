...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Usdacoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.asiadevcoin.com", ""};
static const string testnet_seeds[] = {"testnet-seed.asiadevcoin.com", ""};
